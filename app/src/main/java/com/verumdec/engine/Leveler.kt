...
import com.verumdec.entity.profile.FinancialFigure
...
class Leveler(
    ...
    fun process(statements: List<Statement>): LevelerOutput {
        ...
        allContradictions.addAll(semanticContradictions)
        allContradictions.addAll(timelineContradictions)
        allContradictions.addAll(entityContradictionsList)
        allContradictions.addAll(behavioralContradictions)
